! function (e) {
	...
	return function r(e, t, n) {
		...
		3: [function (e, t, n) {
			...
			var r = e("./url"), i = e("engine.io-client"), s = e("./socket"), o = e("component-emitter"), u = e("socket.io-parser"), a = e("./on"), f = e("component-bind"), l = e("object-component"), c = e("debug")("socket.io-client:manager"), h = e("indexof");
		...
		5: [function (e, t, n) {
			...
			var r = e("socket.io-parser"), i = e("component-emitter"), s = e("to-array"), o = e("./on"), u = e("component-bind"), a = e("debug")("socket.io-client:socket"), f = e("has-binary");
			t.exports = n = h;
			var l = {
				connect: 1,
				connect_error: 1,
		...
		12: [function (e, t, n) {
			(function (n) {
				...
				var r = e("./transports"), i = e("component-emitter"), s = e("debug")("engine.io-client:socket"), o = e("indexof"), u = e("engine.io-parser"), a = e("parseuri"), f = e("parsejson"), l = e("parseqs");
		...
		15: [function (e, t, n) {
			(function (n) {
				...
				i(l, r), l.prototype.supportsBinary = ! 1, l.prototype.doClose = function () {
					...
					var n = this;
					if (! this.form) {
						var r = document.createElement("form"), i = document.createElement("textarea"), u = this.iframeId = "eio_iframe_" + this.index, a;
		...
		16: [function (e, t, n) {
			(function (n) {
				...
				var r = e("xmlhttprequest"), i = e("./polling"), s = e("component-emitter"), o = e("component-inherit"), u = e("debug")("engine.io-client:polling-xhr");
		...
		24: [function (e, t, n) {
			(function (t) {
				...
				function m(e, t, n) {
					var r = new Array(e.length), i = o(e.length, n), s = function (e, n, i) {
						t(n, function (t, n) {
							r[e] = n, i(t, r)
						})
					};
				...
				var r = e("./keys"), i = e("arraybuffer.slice"), s = e("base64-arraybuffer"), o = e("after"), u = e("utf8"), a = navigator.userAgent.match(/Android/i);
				n.protocol = 3;
				var f = n.packets = {
					open: 0,
					close: 1,
					...
					upgrade: 5,
					noop: 6
				}, l = r(f), c = {type: "error", data: "parser error"}, h = e("blob");
				n.encodePacket = function (e, n, r, i) {
					...
					while (s.byteLength > 0) {
						var a = new Uint8Array(s), f = a[0] === 0, l = "";
						for (var h = 1; ; h ++) {
							if (a[h] == 255)break;
							if (l.length > 310) {
								u = ! 0;
		...
		30: [function (t, n, r) {
			(function (t) {
				(function (i) {
					...
					var s = typeof r == "object" && r, o = typeof n == "object" && n && n.exports == s && n, u = typeof t == "object" && t;
					...
					else if (s && ! s.nodeType)if (o)o.exports = w;
					else {
		...
		43: [function (e, t, n) {
			...
			var r = e("debug")("socket.io-parser"), i = e("json3"), s = e("isarray"), o = e("component-emitter"), u = e("./binary"), a = e("./is-buffer");
		...
		46: [function (t, n, r) {
			(function (t) {
				...
				if (! h("json")) {
					...
					if (! l)var w = Math.floor, E = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], S = function (e, t) {
...
(function (root, console) {
	...
	function getWindowSize() {
		var e = document.width || window.outerWidth || document.documentElement.clientWidth, t = document.height || window.outerHeight || document.documentElement.clientHeight;
	...
	function stringify(e, t, n) {
		...
		var r = [], i = [], s, o, u = {}, a = "", f = "", l, c = JSON.stringify(e, function (e, c) {
			if (! c)return c;
			if (c.nodeType) {
	...
	var chost = "console.re", cport = location.protocol === "http:" ? "80" : "443", name = "toServerRe", channel;
	...
	window.location.origin || (window.location.origin = window.location.protocol + "//" + window.location.host), window.consolere === undefined || window.consolere.channel === "YOUR-CHANNEL-NAME" ? channel = document.getElementById("consolerescript").getAttribute("data-channel") || "" : channel = window.consolere.channel || "", channel || (channel = askChannel()), root[name] = function () {
		...
		return o.connect = function (t) {
			...
			var e = printStackTrace(), t = [], n = [].slice.call(arguments);
			...
			function d(e) {
				for (var t = n.length - 1; t >= 0; t --)if (n[t].media === e)return ! 0;
				return ! 1
			}

			function v() {
				var e = m(), t;
				if (a)for (t = e.length - 1; t >= 0; t --)d(e[t]) || n.push(window.matchMedia(e[t]));
				if (u) {
			...
			function m() {
				var e = document.styleSheets, t, n, r, i = [];
				for (n = e.length - 1; n >= 0; n --)try {
					t = e[n].cssRules;
					if (t)for (r = 0; r < t.length; r ++)t[r].type == CSSRule.MEDIA_RULE && i.push(t[r].media.mediaText)
				} catch (s) {
				}
				return i
			}
			...
			var n = [], r = [], i = [], u = ! 1, a = ! 0, f = "landscape", l = window.orientation || 0, c;
			if (e === "type")u = ! 0, a = ! 1;
	...
	var BrowserDetect = {
		...
		dataBrowser: [{
			...
			name: {f: "Safari", s: "SF"},
			vsearch: "Version"
		}, {prop: window.opera, name: {f: "Opera", s: "OP"}, vsearch: "Version"}, {
			str: navigator.vendor,
			substr: "iCab",
			name: {f: "iCab", s: "iC"}
		}, {str: navigator.vendor, substr: "KDE", name: {f: "Konqueror", s: "KDE"}}, {
			str: navigator.userAgent,
			substr: "Firefox",
			name: {f: "Firefox", s: "FF"},
			vsearch: "Firefox"
		}, {str: navigator.vendor, substr: "Camino", name: {f: "Camino", s: "CM"}}, {
			str: navigator.userAgent,
			substr: "Netscape",
			...
			name: {f: "Explorer", s: "IE"},
			vsearch: "rv"
		}, {str: navigator.userAgent, substr: "Mozilla", name: {f: "Netscape", s: "NS"}, vsearch: "Mozilla"}],
		dataOS: [{str: navigator.platform, substr: "Win", name: "Win"}, {
...
var VISIBILITY = function () {
	function e(r, i, s, o, u, a, f) {
		...
		if (l) {
			if ("hidden" === t(l, "overflow") || "scroll" === t(l, "overflow"))if (u + c > l.offsetWidth + l.scrollLeft || u + a - c < l.scrollLeft || i + c > l.offsetHeight + l.scrollTop || i + f - c < l.scrollTop)return ! 1;
...
(function (e, t) {
	...
	function e(t) {
		t = t || {guess: ! 0};
		var n = t.e || null, r = ! ! t.guess, i = new e.implementation, s = i.run(n);
	...
	return e.implementation = function () {
		...
		run: function (e, t) {
			...
			var t = "{anonymous}", n = /^.*line (\d+), column (\d+)(?: in (.+))? in (\S+):$/, r = e.stacktrace.split("\n"), i = [];
			for (var s = 0, o = r.length; s < o; s += 2) {
				var u = n.exec(r[s]);
				if (u) {
					var a = u[4] + ":" + u[1] + ":" + u[2], f = u[3] || "global code";
					f = f.replace(/<anonymous function: (\S+)>/, "$1").replace(/<anonymous function>/, t), i.push(f + "@" + a + " -- " + r[s + 1].replace(/^\s+/, ""))
				}
			}
			return i
		}, opera10b: function (e) {
			var t = /^(.*)@(.+):(\d+)$/, n = e.stacktrace.split("\n"), r = [];
			...
			var t = "{anonymous}", n = /Line (\d+).*script (?:in )?(\S+)(?:: In function (\S+))?$/i, r = e.stacktrace.split("\n"), i = [];
			for (var s = 0, o = r.length; s < o; s += 2) {
				var u = n.exec(r[s]);
				if (u) {
					var a = u[3] || t;
			...
			var t = "{anonymous}", n = /Line (\d+).*script (?:in )?(\S+)/i, r = e.message.split("\n"), i = [];
			...
			var t = "{anonymous}", n = /function\s*([\w\-$]+)?\s*\(/i, r = [], i, s, o = 10;
			try {
			...
			for (var t = 0; t < e.length; ++ t) {
				var n = /\{anonymous\}\(.*\)@(.*)/, r = /^(.*?)(?::(\d+))(?::(\d+))?(?: -- .+)?$/, i = e[t], s = n.exec(i);
				if (s) {
					var o = r.exec(s[1]);
					if (o) {
						var u = o[1], a = o[2], f = o[3] || 0;
			...
			var n = /function\s+([^(]*?)\s*\(([^)]*)\)/, r = /['"]?([$_A-Za-z][$_A-Za-z0-9]*)['"]?\s*[:=]\s*function\b/, i = /['"]?([$_A-Za-z][$_A-Za-z0-9]*)['"]?\s*[:=]\s*(?:eval|new Function)\b/, s = "", o, u = Math.min(t, 20), a, f;
			for (var l = 0; l < u; ++ l) {
