...
(function (P, X, u) {
	...
	function Nd() {
		...
		vc || ((ra = P.jQuery) && ra.fn.on ? (C = ra, w(ra.fn, {
			...
			var c;
			if (Rb)Rb = ! 1;
			else for (var d = 0, e; null != (e = a[d]); d ++)(c = ra._data(e, "events")) && c.$destroy && ra(e).triggerHandler("$destroy");
			b(a)
	...
	function Ie() {
		...
		this.$get = ["$parse", "$exceptionHandler", "$sce", function (c, d, e) {
			...
			function g(f, g, t, r) {
				...
				r = ! ! r;
				for (var n, D, H = 0, v = [], A = [], N = f.length, F = [], s = []; H < N;)if (- 1 != (n = f.indexOf(b, H)) && - 1 != (D = f.indexOf(a, n + h)))H !== n && F.push(S(f.substring(H, n))), H = f.substring(n + h, D), v.push(H), A.push(c(H, K)), H = D + l, s.push(F.length), F.push("");
				else {
			...
			l.prototype = {
				constructor: l, $new: function (a, b) {
					...
					function c(a) {
						...
						var b, d, g, h;
						if (! z(e)) {
							if (J(e))if (Ta(e))for (f !== q && (f = q, t = f.length = 0, k ++), a = e.length, t !== a && (k ++, f.length = t = a), b = 0; b < a; b ++)h = f[b], g = e[b], d = h !== h && g !== g, d || h === g || (k ++, f[b] = g);
							else {
								f !== m && (f = m = {}, t = 0, k ++);
								a = 0;
					...
					return this.$watch(p, function () {
						...
						else for (a in h = {}, e)sc.call(e, a) && (h[a] = e[a]);
						else h = e
					})
				}, $digest: function () {
				...
				compile: function (f, g) {
					...
					return function (a, f, g, k, m) {
						...
						a.$watchCollection(p, function (g) {
							...
							B = J.length;
							K = Array(B);
							for (k = 0; k < B; k ++)if (z = g === J ? k : J[k], G = g[z], E = p(z, G, k), t[E])x = t[E], delete t[E], v[E] = x, K[k] = x;
							else {
